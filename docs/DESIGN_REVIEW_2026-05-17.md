...
### [x] 6. `backdrop-filter` auf Cards verboten – `.summary-card` und `.chart-container`
...
### [x] 7. Falsche `line-height` für DM Serif Display
...
### [x] 8. Sync-Status-Texte: Ellipse + Punkt-Konsistenz
...
### [x] 9. Sync-Status-Live-Region fehlt
